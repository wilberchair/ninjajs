(function() {
  ...
  */
  ...
  for( var i = 0, len= name.length; i < len; i++ ) {
    ...
    // console.log(name.charAt(i) + ' é a última ' + i + 'º letra do meu nome')
  }
  ...
  */
  console.log( '\nMeus amigos:' );
  var friends = ['Napoleão', 'José', 'João', 'Maria', 'Pedro'];
  ...
  */
  console.log( '\nEra "Roberto", agora é:' );
  var name = 'Roberto'
  //se eu usar o replace nao irá trocar a ultima letra, pois pegará a primeira
  ...
  */
  ...
  for(var i = 0, len = myName.length; i < len; i++){
    newName.push(i % 2 === 0 ? myName[i].toLocaleLowerCase() : myName[i].toUpperCase())
  }
  console.log(newName.join(''))
})();